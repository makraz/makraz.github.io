    ...
    >
      ...
      >
        ...
        <p class="mb-8 leading-relaxed">
          ...
          mainly
          <a
            href="https://symfony.com/what-is-symfony"
            class="text-gray-300 hover:text-yellow-dark"
          >
            Symfony ecosystem.
          </a>
          <br />
        ...
        <div class="flex justify-center">
          <router-link
            to="/get-in-touch"
            class="inline-flex text-black bg-yellow border-0 py-2 px-6 hover:bg-yellow-dark rounded text-lg"
          >
            Set up a meeting
          </router-link>
        </div>
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div>
          <h1 class="mt-4 text-xl font-semibold text-white">
            ...
            <!--            </svg>-->
            <img
              class="object-cover object-center rounded w-8 h-8 inline-block mr-3"
              alt="hero"
              src="code.svg"
              width="48"
              height="48"
        ...
        <form>
          <div class="sm:flex justify-start mt-6">
            <form class="flex w-full max-w-sm space-x-3">
              ...
              <button
                class="flex-shrink-0 px-4 py-2 text-black bg-yellow border-0 py-2 px-6 focus:outline-none hover:bg-yellow-dark rounded text-lg"
                type="submit"
              >
                Subscribe
              </button>
